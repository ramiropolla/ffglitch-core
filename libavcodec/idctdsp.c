...
static void ffe_put_pixels_clamped(const int16_t *block, uint8_t *av_restrict pixels, ptrdiff_t line_size) {}
static void ffe_put_signed_pixels_clamped(const int16_t *block, uint8_t *av_restrict pixels, ptrdiff_t line_size) {}
static void ffe_add_pixels_clamped(const int16_t *block, uint8_t *av_restrict pixels, ptrdiff_t line_size) {}
