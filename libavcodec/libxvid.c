...
struct xvid_context {
    ...
    int nopimb;                    /**< Do not use intra mbs for predictive frames */
...
static av_cold int xvid_encode_init(AVCodecContext *avctx)
{
    ...
    if (x->forcemv)
        x->vop_flags    |= FFEDIT_VOP_FORCE_MV;
...
static const AVOption options[] = {
    ...
    { "nopimb",      "Do not use intra mbs for predictive frames", OFFSET(nopimb), AV_OPT_TYPE_INT, { .i64 = 0 },   0,       1, VE         },
