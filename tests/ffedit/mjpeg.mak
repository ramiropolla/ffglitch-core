...
FFEDIT_TESTS += mjpeg_webcam_320_replicate
FFEDIT_TESTS += imagemagick_mjpeg_lena444_128_replicate
...
FFEDIT_TESTS += mjpeg_webcam_320_dht
FFEDIT_TESTS += imagemagick_mjpeg_lena444_128_dht
...
mjpeg_webcam_320_replicate: $(FFEDIT_SRC)/mjpeg_webcam_320.jpg
	$(FFEDIT_SCRIPTS)/replicate.sh "$(FFEDIT_REF)/$@.ref" "$<"
imagemagick_mjpeg_lena444_128_replicate: $(FFEDIT_SRC)/imagemagick_mjpeg_lena444_128.jpg
	$(FFEDIT_SCRIPTS)/replicate.sh "$(FFEDIT_REF)/$@.ref" "$<"
...
mjpeg_webcam_320_dht: $(FFEDIT_SRC)/mjpeg_webcam_320.jpg
	$(FFEDIT_SCRIPTS)/script.sh "$(FFEDIT_REF)/$@.ref" "$<" "$(FFEDIT_JSON)/$@.json" "-f dht" "cat.sh"
imagemagick_mjpeg_lena444_128_dht: $(FFEDIT_SRC)/imagemagick_mjpeg_lena444_128.jpg
	$(FFEDIT_SCRIPTS)/script.sh "$(FFEDIT_REF)/$@.ref" "$<" "$(FFEDIT_JSON)/$@.json" "-f dht" "cat.sh"
