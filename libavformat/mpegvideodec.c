...
FF_DEF_RAWVIDEO_DEMUXER2(mpegvideo, "raw MPEG video", mpegvideo_probe, NULL, AV_CODEC_ID_MPEG1VIDEO, AVFMT_GENERIC_INDEX | AVFMT_FFEDIT_BITSTREAM | AVFMT_FFEDIT_RAWSTREAM)
