...
FF_DEF_RAWVIDEO_DEMUXER2(mjpeg, "raw MJPEG video", mjpeg_probe, "mjpg,mjpeg,mpo", AV_CODEC_ID_MJPEG, AVFMT_GENERIC_INDEX|AVFMT_NOTIMESTAMPS|AVFMT_FFEDIT_BITSTREAM|AVFMT_FFEDIT_RAWSTREAM)
#endif
